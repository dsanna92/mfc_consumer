		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#projectMfcConsumerprojectmfcconsumer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectMfcConsumerprojectmfcconsumer-display": {
								"semanticObject": "projectMfcConsumerprojectmfcconsumer",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectMfcConsumer.projectmfcconsumer",
									"url": sap.ui.require.toUrl("projectMfcConsumer/projectmfcconsumer")
								}
							}
						}
					}
