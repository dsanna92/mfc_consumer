		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#tileprojecttileproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tileprojecttileproject-display": {
								"semanticObject": "tileprojecttileproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tileproject.tileproject",
									"url": sap.ui.require.toUrl("tileproject/tileproject")
								}
							}
						}
					}
